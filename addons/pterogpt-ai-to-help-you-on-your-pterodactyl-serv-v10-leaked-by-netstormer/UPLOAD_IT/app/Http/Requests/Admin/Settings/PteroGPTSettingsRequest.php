...
class PteroGPTSettingsRequest extends AdminFormRequest
{
    public function rules(): array
    {
        return [
            ...
            'limit_chat' => 'required|integer|min:1|max:1000',
            'limit_read' => 'required|integer|min:1|max:1000',
            'limit_write' => 'required|integer|min:1|max:1000',
            'limit_command' => 'required|integer|min:1|max:1000',
        ];
    }
}