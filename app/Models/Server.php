...
class Server extends Model implements Identifiable
{
    ...
    public static array $validationRules = [
        ...
        'folder_id' => 'sometimes|nullable|integer|exists:server_folders,id',
        'split_masteruuid' => 'sometimes|nullable|uuid',
    ...
    /**
     * Gets the folder this server belongs to.
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo<\Pterodactyl\Models\ServerFolder, $this>
     */
