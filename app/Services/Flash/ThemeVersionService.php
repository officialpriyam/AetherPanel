...
class ThemeVersionService
{
    ...
    protected function fetchLatestRelease(): array
    {
        ...
        return Cache::remember($cacheKey, $ttl, function () {
            ...
            try {
                $releaseResponse = Http::withHeaders($headers)->timeout(8)->get((string) config('flash_theme.api_release_url'));
                ...
                $tagsResponse = Http::withHeaders($headers)->timeout(8)->get((string) config('flash_theme.api_tags_url'));
