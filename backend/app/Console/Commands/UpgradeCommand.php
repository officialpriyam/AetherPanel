...
class UpgradeCommand extends Command
{
    ...
    public function handle()
    {
        ...
        if ($this->input->isInteractive()) {
            ...
            if ($isWindows) {
                $this->output->note('Windows detected. Unix ownership and permission adjustment steps will be skipped during upgrade.');
                $user = getenv('USERNAME') ?: $user;
                $group = getenv('USERDOMAIN') ?: $group;
            } elseif (is_null($this->option('user'))) {
            ...
            if (!$isWindows && is_null($this->option('group'))) {
