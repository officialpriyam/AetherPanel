...
class FlashController extends Controller
{
    ...
    {
        return $this->view->make('admin.flash.index', ['logo' => $this->settings->get('settings::flash:logo', '/branding/aether-mark.png'), 'fullLogo' => $this->settings->get('settings::flash:fullLogo', false), 'logoHeight' => $this->settings->get('settings::flash:logoHeight', '32px')]);
    }
