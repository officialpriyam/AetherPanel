...
use Pterodactyl\Http\Middleware\Modules\RequireModuleApiAccess;
use Pterodactyl\Http\Middleware\RequireFrontendAccessKey;
...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        TrustProxies::class,
        HandleCors::class,
        RequireFrontendAccessKey::class,
    ...
    protected $middlewareAliases = [
        ...
        'module' => RequireModuleApiAccess::class,
    ];
}
