...
class Node extends Model
{
    ...
    public static array $validationRules = [
        ...
        'daemon_text' => 'sometimes|string|max:100',
        'container_text' => 'sometimes|string|max:100',
        ...
        'daemonBase' => ['sometimes', 'required', 'regex:/^(\/[\d\w.\-\/ ]+|[A-Za-z]:\\\\[\d\w.\-\\\\ ]+)$/'],
    ...
    protected $attributes = [
        'alert' => null,
        'daemon_text' => '[OurPanel Daemon]:',
        'container_text' => 'container@ourpanel~',
        'public' => true,
        'behind_proxy' => false,
    ...
    public function getConfiguration(): array
    {
        ...
        return [
            ...
            'api' => [
                ...
                'ssl' => [
                    'enabled' => $sslEnabled,
                    'cert' => $sslEnabled ? '/etc/letsencrypt/live/' . Str::lower($this->fqdn) . '/fullchain.pem' : '',
                    'key' => $sslEnabled ? '/etc/letsencrypt/live/' . Str::lower($this->fqdn) . '/privkey.pem' : '',
                ],
            ...
            'remote' => rtrim((string) panel_runtime_config('APP_URL', ''), '/'),
        ];
    }
