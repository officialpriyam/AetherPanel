...
class Permission extends Model
{
    ...
    public const ACTION_PTEROGPT_CHAT = 'pterogpt.chat';
    public const ACTION_SPLIT_MANAGE = 'split.manage';
    ...
    protected static array $permissions = [
        ...
        'subdomain' => [
            'description' => 'Permissions that control a user\'s ability to manage server subdomains.',
            'keys' => [
                'manage' => 'Allows a user to create and delete DNS subdomains for this server.',
            ],
        ],

        'pterogpt' => [
            'description' => 'Permissions that control a user\'s ability to use PriyxStudio AI features.',
            'keys' => [
                'chat' => 'Allows a user to chat with the integrated PriyxStudio AI assistant.',
            ],
        ],

        'split' => [
            'description' => 'Permissions that control a user\'s ability to split server resources into child servers.',
            'keys' => [
                'manage' => 'Allows a user to create and remove split child servers.',
            ],
        ],
    ];
