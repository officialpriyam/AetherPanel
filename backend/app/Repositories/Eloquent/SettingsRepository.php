...
{
    private const PRELOAD_PREFIXES = [
        'settings::flash:',
    ];
    ...
    private static array $preloadedPrefixes = [];
    ...
    private function preloadNamespace(string $key): void
    {
        foreach (self::PRELOAD_PREFIXES as $prefix) {
            if (!str_starts_with($key, $prefix) || isset(self::$preloadedPrefixes[$prefix])) {
                continue;
            }
            ...
            self::$preloadedPrefixes[$prefix] = true;
            break;
        }
    }
}
