...
namespace Pterodactyl\Services\Frontend;
...
class SiteConfigurationService
{
    ...
    public function get(): array
    {
        ...
        $brandAssetPath = '/branding/aether-mark.png';
        $panelOrigin = rtrim((string) (panel_runtime_config('PANEL_FRONTEND_URL', config('app.url')) ?: config('app.url')), '/');
        $brandAssetUrl = $panelOrigin . $brandAssetPath;

        return [
            'name' => config('app.name') ?? 'AetherPanel',
            'flash' => [
                'logo' => $this->settings->get('settings::flash:logo', $brandAssetPath),
                ...
                'meta_favicon' => $this->settings->get('settings::flash:meta_favicon', $brandAssetPath),
                ...
                'colorSchemaPreset' => $this->settings->get('settings::flash:colorSchemaPreset', 'custom'),
                ...
                'warningText' => $this->settings->get('settings::flash:warningText', '#FFE8BE'),
                'warningBorder' => $this->settings->get('settings::flash:warningBorder', '#D6A250'),
                'warningBackground' => $this->settings->get('settings::flash:warningBackground', '#5B4118'),
                'infoText' => $this->settings->get('settings::flash:infoText', '#D8F6FF'),
                'infoBorder' => $this->settings->get('settings::flash:infoBorder', '#4DBBDB'),
                'infoBackground' => $this->settings->get('settings::flash:infoBackground', '#133E54'),
                'textPrimary' => $this->settings->get('settings::flash:textPrimary', '#F8FAFC'),
                'textMuted' => $this->settings->get('settings::flash:textMuted', '#94A3B8'),
                'surfaceBase' => $this->settings->get('settings::flash:surfaceBase', '#08111A'),
                'surfaceElevated' => $this->settings->get('settings::flash:surfaceElevated', '#0C1723'),
                'surfaceCard' => $this->settings->get('settings::flash:surfaceCard', '#122031'),
                'surfaceOverlay' => $this->settings->get('settings::flash:surfaceOverlay', '#0A1520'),
                'borderColor' => $this->settings->get('settings::flash:borderColor', '#22384C'),
                'borderStrong' => $this->settings->get('settings::flash:borderStrong', '#33536F'),
                ...
                'lightmode_warningText' => $this->settings->get('settings::flash:lightmode_warningText', '#7A4A06'),
                'lightmode_warningBorder' => $this->settings->get('settings::flash:lightmode_warningBorder', '#D29A35'),
                'lightmode_warningBackground' => $this->settings->get('settings::flash:lightmode_warningBackground', '#FFF4DB'),
                'lightmode_infoText' => $this->settings->get('settings::flash:lightmode_infoText', '#0E5168'),
                'lightmode_infoBorder' => $this->settings->get('settings::flash:lightmode_infoBorder', '#45A8C6'),
                'lightmode_infoBackground' => $this->settings->get('settings::flash:lightmode_infoBackground', '#DFF6FC'),
                'lightmode_textPrimary' => $this->settings->get('settings::flash:lightmode_textPrimary', '#102130'),
                'lightmode_textMuted' => $this->settings->get('settings::flash:lightmode_textMuted', '#5D7B8D'),
                'lightmode_surfaceBase' => $this->settings->get('settings::flash:lightmode_surfaceBase', '#F5FBFD'),
                'lightmode_surfaceElevated' => $this->settings->get('settings::flash:lightmode_surfaceElevated', '#FFFFFF'),
                'lightmode_surfaceCard' => $this->settings->get('settings::flash:lightmode_surfaceCard', '#F2F8FC'),
                'lightmode_surfaceOverlay' => $this->settings->get('settings::flash:lightmode_surfaceOverlay', '#E5F2F8'),
                'lightmode_borderColor' => $this->settings->get('settings::flash:lightmode_borderColor', '#D4E4EE'),
                'lightmode_borderStrong' => $this->settings->get('settings::flash:lightmode_borderStrong', '#B7CDD9'),
            ...
            'urls' => [
                'frontend' => panel_runtime_config('PANEL_FRONTEND_URL'),
                'api' => config('app.url'),
            ],
            'user' => $user ? $user->toVueObject() : null,
        ];
    }
}
