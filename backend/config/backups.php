...
return [
    ...
    'default' => panel_runtime_config('APP_BACKUP_DRIVER', Backup::ADAPTER_WINGS),
    ...
    'presigned_url_lifespan' => (int) panel_runtime_config('BACKUP_PRESIGNED_URL_LIFESPAN', 60),
    ...
    'max_part_size' => panel_runtime_config('BACKUP_MAX_PART_SIZE', 5 * 1024 * 1024 * 1024),
    ...
    'prune_age' => panel_runtime_config('BACKUP_PRUNE_AGE', 360),
    ...
    'throttles' => [
        'limit' => panel_runtime_config('BACKUP_THROTTLE_LIMIT', 2),
        'period' => panel_runtime_config('BACKUP_THROTTLE_PERIOD', 600),
    ],
    ...
    'disks' => [
        ...
        's3' => [
            ...
            'region' => panel_runtime_config('AWS_DEFAULT_REGION'),
            ...
            'bucket' => panel_runtime_config('AWS_BACKUPS_BUCKET'),
            ...
            'prefix' => panel_runtime_config('AWS_BACKUPS_BUCKET') ?? '',

            'endpoint' => panel_runtime_config('AWS_ENDPOINT'),
            'use_path_style_endpoint' => panel_runtime_config('AWS_USE_PATH_STYLE_ENDPOINT', false),
            'use_accelerate_endpoint' => panel_runtime_config('AWS_BACKUPS_USE_ACCELERATE', false),

            'storage_class' => panel_runtime_config('AWS_BACKUPS_STORAGE_CLASS'),
        ],
    ],
];
