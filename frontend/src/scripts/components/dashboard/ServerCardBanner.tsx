...
export default ({ server }: { server: Server }) => {
    ...
    return (
        ...
        >
            <div className="flex z-10 items-center justify-between bg-center bg-cover bg-no-repeat px-6 pt-5 pb-10 relative" css={`background-image:url(${server.eggImage ? server.eggImage : '/flash/minecraft-banner.png'})`}>
                <div className="z-[-1] absolute inset-0" css={'background-color:rgba(15, 23, 42, 0.7);'}/>
