...
const AppearanceWrapper = () => {
    const { i18n, t } = useTranslation('flash/account');
    ...
    const modeToggler = String(useStoreState((state: ApplicationStore) => state.settings.data!.flash.modeToggler));
    const langSwitch = String(useStoreState((state: ApplicationStore) => state.settings.data!.flash.langSwitch));
    const defaultMode = useStoreState((state: ApplicationStore) => state.settings.data!.flash.defaultMode);
