...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
    ({ children, shape, size, variant, isSecondary, className, ...rest }, ref) => {
        const resolvedVariant = isSecondary ? Options.Variant.Secondary : variant;
        ...
        return (
            <button
                ...
                className={classNames(
                    ...
                    styles.primary,
                    {
                        [styles.secondary]: resolvedVariant === Options.Variant.Secondary,
