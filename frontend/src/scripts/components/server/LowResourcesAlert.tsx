...
export default () => {
    ...
    const lowResourcesAlert = String(useStoreState((state: ApplicationStore) => state.settings.data!.flash.lowResourcesAlert));
    const billing = String(useStoreState((state: ApplicationStore) => state.settings.data!.flash.billing));
