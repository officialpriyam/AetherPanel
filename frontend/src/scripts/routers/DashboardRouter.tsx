...
const accountRoutePath = (path: string) => (path === '/' ? '/account' : `/account${path}`);
                ...
                <TransitionRouter>
                    <React.Suspense fallback={<Spinner centered />}>
                        <Switch location={location}>
                            ...
                            <Route path={['/dashboard/servers', '/dashboard/servers/']} exact>
                            ...
                            {routes.account.map(({ path, component: Component }) => (
                                <Route key={path} path={[accountRoutePath(path), `${accountRoutePath(path)}/`]} exact>
                                    <Component />
                                </Route>
                            ))}
                            <Route path={'*'}>
