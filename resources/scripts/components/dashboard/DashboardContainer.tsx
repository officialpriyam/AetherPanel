        ...
        <PageContentBlock title={'Dashboard'} showFlashKey={'dashboard'}>
            {String(socialButtons) == 'true' && (
                <div className={'flex lg:gap-4 gap-2 lg:flex-row flex-col mb-4'}>
                    {socialDiscord && (
                        <a href={socialDiscord} target="_blank" className={'group w-full bg-gray-700 backdrop rounded-box flex items-center justify-between px-6 py-5'}>
                            <div>
                            ...
                            <FaDiscord className={'text-[2.5rem] text-flash'} />
                        </a>
                    )}
                    {socialBilling && (
                        <a href={socialBilling} target="_blank" className={'group w-full bg-gray-700 backdrop rounded-box flex items-center justify-between px-6 py-5'}>
                            <div>
                                <p className={'font-medium text-gray-100 flex items-center'}>
                                    {t('billing-area')}
                                    <LuChevronRight className={'opacity-0 ml-0 group-hover:opacity-75 group-hover:ml-2 duration-300'} />
                            ...
                            <LuCreditCard className={'text-[2.5rem] text-flash'} />
                        </a>
                    )}
                    {socialStatus && (
                        <a href={socialStatus} target="_blank" className={'group w-full bg-gray-700 backdrop rounded-box flex items-center justify-between px-6 py-5'}>
                            <div>
                                <p className={'font-medium text-gray-100 flex items-center'}>
                                    {t('server-status')}
                                    <LuChevronRight className={'opacity-0 ml-0 group-hover:opacity-75 group-hover:ml-2 duration-300'} />
                            ...
                            <LuRouter className={'text-[2.5rem] text-flash'} />
                        </a>
                    )}
                    {socialCustom && (
                        <a href={socialCustom} target="_blank" className={'group w-full bg-gray-700 backdrop rounded-box flex items-center justify-between px-6 py-5'}>
                            <div>
                            ...
                            <LuWandSparkles className={'text-[2.5rem] text-flash'} />
                        </a>
                    )}
                </div>
            )}
