...
const checkboxStyle = css<Props>`
    ${tw`bg-neutral-500 cursor-pointer appearance-none inline-block align-middle select-none flex-shrink-0 w-4 h-4 text-flash border border-neutral-300 rounded-sm`};
    color-adjust: exact;
