...
export default ({ activity, children }: Props) => {
    ...
    const ipFlag = String(useStoreState((state: ApplicationStore) => state.settings.data!.flash.ipFlag));
                ...
                <div className={'flex-1 px-4 sm:px-0'}>
                    <div className={'flex items-center text-gray-50'}>
                        ...
                        <Link
                            ...
                            className={'transition-colors duration-75 active:text-flash hover:text-flash'}
                        >
                            {activity.event}
                        </Link>
