...
const InfoCardAdvanced = () => {
    const { t } = useTranslation(['flash/server/dashboard', 'flash/utilities']);
    ...
    return(
        <TitledGreyBox title={t('server-info.title')}>
            <div className={'grid grid-cols-2 pb-4 border-b-2 border-gray-600'}>
                <span className={'text-gray-300'}>{t('status', { ns: 'flash/utilities' })}:</span>
                <p>
                    ...
                    >
                        {status === 'offline' 
                            ? t('offline', { ns: 'flash/utilities' })
                            : status === 'running'
                            ? t('online', { ns: 'flash/utilities' })
                            : status === 'starting'
                            ? t('starting', { ns: 'flash/utilities' })
                            : status === 'stopping'
                            ? t('stopping', { ns: 'flash/utilities' })
                            : ''
                        }
                    </span>
                </p>
