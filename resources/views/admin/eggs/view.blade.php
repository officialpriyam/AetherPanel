                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label for="pImage" class="control-label">Egg image <b style="background-color:#17078D;font-size:1rem;padding:2px 7px;border-radius:100px;font-weight:600;">FLASH</b></label>
