        ...
        <div class="col-sm-6">
            <div class="box">
                ...
                <div class="box-body row">
                    ...
                    <div class="form-group col-xs-12">
                        <label for="alert" class="control-label">Node alert <b style="background-color:#17078D;font-size:1rem;padding:2px 7px;border-radius:100px;font-weight:600;">FLASH</b></label>
                        <div>
                    ...
                    <div class="form-group col-xs-12">
                        <label for="daemon_text" class="control-label">Daemon text <b style="background-color:#17078D;font-size:1rem;padding:2px 7px;border-radius:100px;font-weight:600;">FLASH</b></label>
                        <div>
                    ...
                    <div class="form-group col-xs-12">
                        <label for="container_text" class="control-label">Container text <b style="background-color:#17078D;font-size:1rem;padding:2px 7px;border-radius:100px;font-weight:600;">FLASH</b></label>
                        <div>
