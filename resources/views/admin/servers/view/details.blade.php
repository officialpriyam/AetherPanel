    ...
    $('#pUserId').select2({
        ...
        templateResult: function (data) {
            ...
            return '<div class="user-block"> \
                <div class="img-circle img-bordered-xs" style="background-color: var(--primary, #0EA5E9); color: white; display: inline-flex; align-items: center; justify-content: center; width: 40px; height: 40px; font-weight: bold; float: left;">' + escapeHtml(data.name_first).charAt(0) + escapeHtml(data.name_last).charAt(0) + '</div> \
                <span class="username"> \
        ...
        templateSelection: function (data) {
            ...
            return '<div> \
                <span> \
                    <div class="img-rounded img-bordered-xs" style="background-color: var(--primary, #0EA5E9); color: white; display: inline-flex; align-items: center; justify-content: center; width: 28px; height: 28px; font-weight: bold; margin-top: -4px;">' + escapeHtml(data.name_first).charAt(0) + escapeHtml(data.name_last).charAt(0) + '</div> \
                </span> \
