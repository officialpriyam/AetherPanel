                    ...
                    <tbody>
                        @foreach ($users as $user)
                            <tr class="align-middle">
                                ...
                                <td class="text-center">
                                    <div class="img-circle" style="background-color: var(--primary, #0EA5E9); color: white; display: inline-flex; align-items: center; justify-content: center; width: 20px; height: 20px; font-weight: bold; font-size: 10px;">
                                        {{ substr($user->name_first, 0, 1) }}{{ substr($user->name_last, 0, 1) }}
                                    </div>
                                </td>
                            </tr>
                        @endforeach
