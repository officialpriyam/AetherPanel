        ...
        <div class="col-xs-12">
            <div class="nav-tabs-custom nav-tabs-floating">
                <ul class="nav nav-tabs">
                    ...
                    <li @if($activeTab === 'subdomain')class="active"@endif><a href="{{ route('admin.settings.subdomain') }}">Subdomain</a></li>
                    <li @if($activeTab === 'pterogpt')class="active"@endif><a href="{{ route('admin.settings.pterogpt') }}">PriyxStudio AI</a></li>
                </ul>
            </div>
        </div>
    </div>
