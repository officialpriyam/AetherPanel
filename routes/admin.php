...
Route::group(['prefix' => 'flash'], function () {
    Route::get('/', [Admin\Flash\FlashController::class, 'index'])->name('admin.flash');
    Route::post('/', [Admin\Flash\FlashController::class, 'store']);

    Route::get('/layout', [Admin\Flash\FlashLayoutController::class, 'index'])->name('admin.flash.layout');
    Route::post('/layout', [Admin\Flash\FlashLayoutController::class, 'store']);

    Route::get('/components', [Admin\Flash\FlashComponentsController::class, 'index'])->name('admin.flash.components');
    Route::post('/components', [Admin\Flash\FlashComponentsController::class, 'store']);

    Route::get('/announcement', [Admin\Flash\FlashAnnouncementController::class, 'index'])->name('admin.flash.announcement');
    Route::post('/announcement', [Admin\Flash\FlashAnnouncementController::class, 'store']);

    Route::get('/styling', [Admin\Flash\FlashStylingController::class, 'index'])->name('admin.flash.styling');
    Route::post('/styling', [Admin\Flash\FlashStylingController::class, 'store']);


    Route::get('/colors', [Admin\Flash\FlashColorsController::class, 'index'])->name('admin.flash.colors');
    Route::post('/colors', [Admin\Flash\FlashColorsController::class, 'store']);

    Route::get('/advanced', [Admin\Flash\FlashAdvancedController::class, 'index'])->name('admin.flash.advanced');
    Route::post('/advanced', [Admin\Flash\FlashAdvancedController::class, 'store']);

    Route::get('/social', [Admin\Flash\FlashSocialController::class, 'index'])->name('admin.flash.social');
    Route::post('/social', [Admin\Flash\FlashSocialController::class, 'store']);

    Route::get('/eggs', [Admin\Flash\FlashEggsController::class, 'index'])->name('admin.flash.eggs');
    Route::post('/eggs', [Admin\Flash\FlashEggsController::class, 'store']);

    Route::get('/addons', [Admin\Flash\FlashAddonsController::class, 'index'])->name('admin.flash.addons');
    Route::post('/addons', [Admin\Flash\FlashAddonsController::class, 'store']);
});
...
Route::group(['prefix' => '/tickets'], function () {
    ...
    Route::get('/view/{ticket}', [Admin\TicketsController::class, 'view'])->name('admin.tickets.view');

    Route::post('/view/{ticket}/status', [Admin\TicketsController::class, 'status'])->name('admin.tickets.view.status');
    Route::post('/view/{ticket}/reply', [Admin\TicketsController::class, 'reply'])->name('admin.tickets.view.reply');

    Route::group(['prefix' => '/categories'], function () {
        Route::get('/create', [Admin\TicketsController::class, 'index'])->name('admin.tickets.categories.create');
        Route::get('/view/{category}', [Admin\TicketsController::class, 'index'])->name('admin.tickets.categories.view');

        Route::post('/create', [Admin\TicketsController::class, 'createCategory']);
        Route::post('/edit/{category}', [Admin\TicketsController::class, 'editCategory'])->name('admin.tickets.categories.edit');

        Route::delete('/delete', [Admin\TicketsController::class, 'deleteCategory'])->name('admin.tickets.categories.delete');
    });
});
