...
Route::group(['prefix' => '/folders'], function () {
    ...
    Route::post('/{folder}', [Client\ServerFolderController::class, 'update']);
    Route::delete('/{folder}', [Client\ServerFolderController::class, 'delete']);
    Route::post('/{server}/move', [Client\ServerFolderController::class, 'move']);
});
...
Route::group(['prefix' => '/tickets'], function () {
    Route::get('/', [Client\TicketsController::class, 'index']);
    Route::get('/view/{ticket}', [Client\TicketsController::class, 'view']);
    Route::post('/create', [Client\TicketsController::class, 'create'])->middleware('throttle:6,60');
    Route::post('/{ticket}/message', [Client\TicketsController::class, 'message']);
});
...
Route::group([
    ...
    Route::group(['prefix' => '/splitted'], function () {
        ...
        Route::post('/split', [Client\Servers\SplitController::class, 'split']);
        Route::post('/splitremove', [Client\Servers\SplitController::class, 'delete']);
    });

    Route::group(['prefix' => '/minecraft/versions'], function () {
        Route::get('/installed', [Client\Servers\VersionChangerController::class, 'installed']);
        Route::post('/install', [Client\Servers\VersionChangerController::class, 'install']);
        Route::get('/types', [Client\Servers\VersionChangerController::class, 'types']);
        Route::get('/types/{type}', [Client\Servers\VersionChangerController::class, 'versions'])->middleware(['throttle:50,5']);
        Route::get('/types/{type}/{version}', [Client\Servers\VersionChangerController::class, 'builds'])->middleware(['throttle:50,5']);
    });

    Route::group(['prefix' => '/mcmodpacks'], function () {
        Route::get('/', [Client\Servers\McModpacksController::class, 'getModPacks']);
        Route::get('/mcversions', [Client\Servers\McModpacksController::class, 'getMcVersions']);
        Route::get('/description', [Client\Servers\McModpacksController::class, 'getModpacksDescription']);
        Route::post('/install', [Client\Servers\McModpacksController::class, 'install']);
        Route::get('/getversionsize', [Client\Servers\McModpacksController::class, 'getversionsize']);
    });
